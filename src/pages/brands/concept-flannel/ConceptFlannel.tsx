...
const ConceptFlannel = () => {
    ...
    return (
        ...
        <Typography variant="h1" style={{ margin: "1rem", textAlign: "center", fontFamily: "Playfair Display", fontSize: "3rem"}}>Concept Flannel</Typography>
