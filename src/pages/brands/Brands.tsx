...
const Brands = () => {
    ...
    return (
        <div style={{ padding: "0 5rem", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", maxWidth: "44rem", alignItems: "center", justifyContent: "center" }}>
                <div style={{ maxWidth: "20rem", padding: "1rem" }}>
                    ...
                    <Typography variant="h2" style={{ margin: "1rem", textAlign: "center", fontFamily: "Playfair Display", fontSize: "1.5rem"}}>Wear of Absolue</Typography>
                </div>
                <div style={{ maxWidth: "20rem", padding: "1rem" }}>
                    <Link to={"/brands/lashstudio"}>
                        <img src={IMG_5147} style={{ width: "100%"}} />
                    </Link>
                    <Typography variant="h2" style={{ margin: "1rem", textAlign: "center", fontFamily: "Playfair Display", fontSize: "1.5rem"}}>Lash Studio</Typography>
                </div>
                ...
                <div style={{ maxWidth: "20rem", padding: "1rem" }}>
                    ...
                    <Typography variant="h2" style={{ margin: "1rem", textAlign: "center", fontFamily: "Playfair Display", fontSize: "1.5rem"}}>Concept Flannel</Typography>
                </div>
                ...
                <div style={{ maxWidth: "20rem", padding: "1rem" }}>
                    ...
                    <Typography variant="h2" style={{ margin: "1rem", textAlign: "center", fontFamily: "Playfair Display", fontSize: "1.5rem"}}>Mayam</Typography>
                </div>
