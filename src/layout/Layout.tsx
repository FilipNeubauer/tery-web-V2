  ...
  return (
    <>
      {!isWideScreen && (
        <nav
          style={{
            ...
            flexDirection: "row",
            alignItems: "center",
            background: location.pathname !== "/" ? colors.white : "none",
        ...
        >
          ...
          <div style={{ zIndex: 1300 }}>
            <Hamburger
              direction="right"
              color={
                location.pathname === "/" || open ? colors.black : colors.black
              }
              size={23}
              toggled={open}
              toggle={setOpen}
      ...
      <Drawer
        ...
        anchor="right"
        PaperProps={{
          sx: { backgroundColor: "white", width: !isWideScreen ? "100%" : "" },
        }}
      >
      ...
      <main
        style={{
          marginLeft: isWideScreen ? "250px" : 0,
          paddingTop: location.pathname === "/" ? 0 : "2rem",
      ...
      >
        <IconButton onClick={openIg} style={{ color: "black" }}>
          <InstagramIcon />
        </IconButton>
        <div>
          <Typography
